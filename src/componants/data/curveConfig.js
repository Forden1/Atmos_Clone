...
export const curvePoints = [
  ...
  new THREE.Vector3(-10, 0, -FLIGHT_CONFIG.CURVE_DISTANCE*2),
  new THREE.Vector3(10, 0, -FLIGHT_CONFIG.CURVE_DISTANCE*3),
  new THREE.Vector3(10, 0, -FLIGHT_CONFIG.CURVE_DISTANCE*4),
  new THREE.Vector3(-10, 0, -FLIGHT_CONFIG.CURVE_DISTANCE*5),
  ...
  new THREE.Vector3(0, -5, -FLIGHT_CONFIG.CURVE_DISTANCE*9),
  new THREE.Vector3(0, 5, -FLIGHT_CONFIG.CURVE_DISTANCE*10),
];